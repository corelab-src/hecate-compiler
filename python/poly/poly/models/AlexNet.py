...
class AlexNet(nn.Module):
    def __init__(self):
        ...
        self.Conv2d_1 = nn.Conv2d(
            kernel_size=3, in_channels=3, out_channels=96, padding=1
        )
        self.bn_1 = nn.BatchNorm2d(96)
        self.avgpool_1 = nn.AvgPool2d((3, 3), stride=2, padding=1)

        self.Conv2d_2 = nn.Conv2d(
            kernel_size=5, in_channels=96, out_channels=256, padding=2
        )
        self.bn_2 = nn.BatchNorm2d(256)
        self.avgpool_2 = nn.AvgPool2d((3, 3), stride=2, padding=1)

        self.Conv2d_3 = nn.Conv2d(
            kernel_size=3, in_channels=256, out_channels=384, padding=1
        )
        self.bn_3 = nn.BatchNorm2d(384)
        self.Conv2d_4 = nn.Conv2d(
            kernel_size=3, in_channels=384, out_channels=384, padding=1
        )
        self.bn_4 = nn.BatchNorm2d(384)
        self.Conv2d_5 = nn.Conv2d(
            kernel_size=3, in_channels=384, out_channels=256, padding=1
        )
