...
def pad_fold_sum_elements(data, padded_length=hc.padded_length, input_length=hc.input_length):
    """
...
def dict_fold_sum_elements(data, input_length=hc.input_length):
    ...
    @return: ciphertext with sum in first slot
    """
    power_dict = {1: 0, 2: 1, 4: 2, 8: 3, 16: 4, 32: 5, 64: 6, 128: 7, 256: 8, 512: 9, 1024: 10, 2048: 11, 4096: 12, 8192: 13, 16384: 14, 32768: 15, 65536: 16, 131072: 17, 262144: 18}
...
def cov_elements(x_data, y_data, masked_x_mean, masked_y_mean, input_length, padded_length):
    """
...
# experimental
def opt_corrcoef_elements(covariance, small_x_std, small_y_std, fit_factor, input_length=hc.input_length):
    """
